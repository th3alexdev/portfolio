    ...
    return (
        <>
            ...
            <main className='main' onClick={on ? toggle : null}>
                ...
                <section id='projects' className='projects' aria-labelledby='projectsTitle'>
                    <div className='cards-display' role='list'>
                        {
                            projects.map((project, index) => (                                
                                <Card key={index} {...project} direction={index % 2 === 0 ? 'right' : 'left'} pos={index}/>
                            ))
                        }
                    </div>
                        ...
                        <div className='about-tools'>
                            <ul className='tools'>
                                ...
                                <li className='tools__li'>
                                    ...
                                    <p className='tools__li-desc'>CSS3/SCSS/SASS, Tailwind, Bootstrap</p>
                                </li>
                                <li className='tools__li'>
                                    <h2 className='tools__li-title'>
